<footer class="footer">
    <div class="footer__newsletter">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-open-heart-fill footer__svg" viewBox="0 0 16 16">
            <path
        ...
        <p class="footer__p">Suscribirse a nuestra newsletter</p>
        <a class="footer__apuntar" href="">Apúntate</a>
    </div>
